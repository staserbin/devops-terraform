...
#
# Purpose   : Resource creation sequence.
# Author    : StanOps Team
# Created   : 2025-01-09
...
resource "aws_instance" "my_server_web" {
  ...
  tags = {
    Name        = "WEB Amazon Linux Server"
    Description = "Test EC2 with Amazon Linux by Terraform for Lesson-7"
    Owner       = "Stan Serbin"
  }

  depends_on = [aws_instance.my_server_db] // my_server_web will be created only after my_server_db
}
